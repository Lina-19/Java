...
public class LoginView extends JFrame implements ActionListener {
    ...
    private JButton btn_login,btn_cancel,btn_inscrit;
    ...
    private void initButton(){
        ...
        btn_inscrit =new JButton("S'inscrir");
        // personaliser du boutton
        btn_inscrit.setFont(new Font("Optima",Font.BOLD,17));
        //modification de la couleur du button
        btn_inscrit.setForeground(new Color(105,59,105,255));
        //alligner le boutton au centre
        btn_inscrit.setHorizontalAlignment(JButton.CENTER);
        btn_inscrit.setBorderPainted(false);
        btn_inscrit.addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==btn_cancel){
            ...
            System.exit(0);
                ...
                String log=txt_login.getText();
                String pass=txt_pass.getText();
            if (log.equals(Admin.getInstance().getLogin()) && pass.equals(Admin.getInstance().getMotDePasse()))
                new MyFrame("Banque");
            else {
                for(Client cl:bq.getClientsDeBanque()){
                    if(cl.getLogin().equals(log) && cl.getMotDePasse().equals(pass)){
                        new ClientFrame();
                    }
                }
            }
        ...
        if(e.getSource()==btn_inscrit){
            new ClientFormView();
            System.out.println("s'inscrir");
        }
    }
}
